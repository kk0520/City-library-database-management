...
<body>
	...
	<nav class="class=" navbar
		...
		<ul class="nav nav-pills">
			...
			<li class="nav-item"><a class="nav-link active"
				href="AddDoc.jsp">Add Document</a></li>
			...
			<li class="nav-item"><a class="nav-link"
				href="FreqBorrowServlet">Frequent Borrowers</a></li>

			<li class="nav-item"><a class="nav-link" href="MostBorrow.jsp">Most
					Borrowed Books</a></li>

			<li class="nav-item"><a class="nav-link"
				href="PopularBooksServlet">2020's Popular Books</a></li>
	...
	<div class="col-sm">
		<div class="card">
			<h5 class="card-header">Add Document Copy</h5>
			<div class="card-body">
				<form action="http://localhost:8080/LibraryManagement/AddDocServlet"
					method="post">
					<div class="input-group mb-3">
						<input type="text" class="form-control" placeholder="Document ID"
							aria-label="DocID" aria-describedby="basic-addon1" name="DocId">

					</div>
					<div class="input-group mb-3">
						<input type="text" class="form-control" placeholder="Copy Number"
							aria-label="CopyNo" aria-describedby="basic-addon1"
							name="CopyNum">
					...
					<div class="input-group mb-3">
						<input type="text" class="form-control" placeholder="Position"
							aria-label="" aria-describedby="basic-addon1" name="position">
