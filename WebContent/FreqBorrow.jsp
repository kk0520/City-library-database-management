...
<form action="http://localhost:8080/LibraryManagement/FreqBorrowServlet"
	method="post"></form>
<body>
...
<nav class="class="navbar navbar-light" style="background-color: #D3D3D3;"">
		<ul class="nav nav-pills">
			...
			<li class="nav-item"><a class="nav-link active" href="FreqBorrowServlet">Frequent Borrowers</a></li>
